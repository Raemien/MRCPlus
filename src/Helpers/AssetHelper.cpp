...
{
    Array<uint8_t>* bytes = System::Convert::FromBase64String(il2cpp_utils::newcsstr(encodedbytes));
...
UnityEngine::Shader* LoadFXAAEffect()
{
    ...
    Array<UnityEngine::Object*>* shaderArray = ab_LoadAllAssets(bundle, il2cpp_utils::newcsstr(""), csTypeOf(UnityEngine::Shader*));
    if (shaderArray->Length() < 1) return nullptr;
    UnityEngine::Shader* clonedShader = reinterpret_cast<UnityEngine::Shader*>(shaderArray->values[0]);
    bundle->Unload(false);
    return clonedShader;
}
